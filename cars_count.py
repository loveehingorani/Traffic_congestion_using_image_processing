...
cap = cv2.VideoCapture('cctv2_trim.mp4')
ret, img = cap.read()
scaling_factor = 0.4
...
while True:
    ...
    cv2.putText(gray, 'total cars= ' + str(cars_count), (0, height), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 255))
    ...
    #     update = True
    #     test_database.test_func(cars_count)
